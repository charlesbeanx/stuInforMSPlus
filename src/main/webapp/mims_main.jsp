...
<div class="layui-fluid main">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md3">
            <div class="info-box">
                ...
                <div class="info-box-content">在线人数
                    <span class="info-box-number" id="s1">${miamInforCount.onlineCount}</span>
                </div>
            </div>
        </div>
        ...
        <div class="layui-col-md3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number" id="s3">${miamInforCount.empCount}</span>
                </div>
            </div>
        </div>
        <div class="layui-col-md3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number" id="s4">${miamInforCount.gradeCount}</span>
                </div>
            </div>
        </div>
        <div class="layui-col-md3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number" id="s5">${miamInforCount.studentCount }</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div>
        <table class="layui-table" id="tbdata">
            ...
            <tbody>
            <c:forEach items="${userLoginLogs}" var="l">
                <tr>
